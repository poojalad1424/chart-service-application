...
import com.example.chartserviceapplication.databinding.TabcFragmentLayoutBinding
...
class TabCFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding: TabcFragmentLayoutBinding = DataBindingUtil.inflate(inflater,
            R.layout.tabc_fragment_layout, container, false)
