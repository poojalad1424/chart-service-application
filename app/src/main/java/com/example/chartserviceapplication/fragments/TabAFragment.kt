...
import com.example.chartserviceapplication.databinding.TabFragmentLayoutBinding
...
class TabAFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding: TabFragmentLayoutBinding = DataBindingUtil.inflate(inflater,
            R.layout.tab_fragment_layout, container, false)
